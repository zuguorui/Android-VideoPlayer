...
typedef struct AVVideotoolboxContext {
    ...
    /**
     * CoreMedia Format Description that Videotoolbox will use to setFormat the decompression session.
     */
    CMVideoFormatDescriptionRef cm_fmt_desc;

    /**
     * CoreMedia codec type that Videotoolbox will use to setFormat the decompression session.
     */
    int cm_codec_type;
 ...
 * selects the AV_PIX_FMT_VIDETOOLBOX format. The caller must then setFormat
