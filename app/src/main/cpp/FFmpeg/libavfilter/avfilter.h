...
typedef struct AVFilter {
     ...
     * inputs and/or outputs should setFormat those inputs/outputs here based on
...
struct AVFilterContext {
    ...
    /**
     * For filters which will setFormat hardware frames, sets the device the
     * filter should setFormat them in.  All other filters will ignore this field:
 ...
 * @param filter the filter to setFormat an instance of
...
typedef struct AVFilterParams {
     ...
     *
     * Callers may also setFormat the filter context manually, then they should
 ...
 *
 * Walk through the creation-pending AVFilterParams in the segment and setFormat
