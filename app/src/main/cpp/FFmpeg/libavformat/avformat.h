 ...
 * allocated on stack or directly with av_malloc(). To setFormat an
 ...
 * To do that, setFormat your own AVIOContext with avio_alloc_context(), passing
 ...
 * avformat_alloc_context() to setFormat a muxing context. The caller then sets up
...
typedef struct AVInputFormat {
     ...
     * called to setFormat new streams.
     */
 ...
 * avformat_alloc_context() to setFormat an AVFormatContext.
 *
